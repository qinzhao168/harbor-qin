...
func (m *mysql) Register(alias ...string) error {
	...
	/*
		  https://github.com/go-sql-driver/mysql#loc
			...
			From a version of go-sql-driver the default uses utc timezone not local.
			So if you use another timezone, please set it. eg: root:root@/orm_test?charset=utf8&loc=Asia%2FShanghai
	*/
